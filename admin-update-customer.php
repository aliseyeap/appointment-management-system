...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: admin-customer.php?update=success&name=".urlencode($customerName));
    exit(); // Stop script execution
}

// If form is not submitted or invalid request method, redirect to admin-customer.php
