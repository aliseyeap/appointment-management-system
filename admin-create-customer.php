  ...
  <section class="home-section">
    ...
    <div class="content">
      <div class="content-header">
        <h3 class="content-title">Create New Customer</h3>
      </div>

    <!-- Customer Form Container -->
    <div class="customer-form-container">
        <form id="customerForm" class="customer-form" action="admin-add-customer.php" method="post">
          <div class="form-group">
              <label for="customerName">Customer Name</label>
              <input type="text" id="customerName" name="customerName" class="customer-input" placeholder="Please enter the name of the customer" required>
          </div>
          ...
          <div class="form-group">
              ...
              <input type="email" id="customerEmail" name="customerEmail" class="customer-input" placeholder="Please enter the email of the customer" required>
          </div>

          <div class="form-group">
              <label for="customerPhoneNumber">Phone Number</label>
              <input type="text" id="customerPhoneNumber" name="customerPhoneNumber" class="customer-input" placeholder="Please enter the phone number of the customer" required>
          </div>
...
<script>
  ...
  for (var i = 0; i < arrow.length; i++) {
      arrow[i].addEventListener("click", (e) => {  // Fixed: arrow[i] instead of arrow[i
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      document.querySelector(".admin-new-app-btn-submit").addEventListener("click", function(event) {
      ...
      document.querySelector(".admin-new-app-btn-cancel").addEventListener("click", function() {
