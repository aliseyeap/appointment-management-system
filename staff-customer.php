    ...
    <div class="content">
      <div class="content-header">
        ...
        <div class="content-tools">
          <a href="staff-create-customer.php" class="btn btn-flat btn-primary"><i class='bx bx-plus'></i> Create New</a>
        </div>
      </div>
          ...
          <tbody>
            ...
            foreach ($customerList as $key => $customer):
                ...
                <tr>
                  ...
                  <td><?php echo date("d M Y H:i:s", strtotime($customer['date_created'])); ?></td>
                  <td><?php echo date("d M Y H:i:s", strtotime($customer['date_updated'])); ?></td>
                  <td>
                    <!-- Update button container -->
                    <div class="button-container">
                        <a href="staff-view-customer.php?customer_id=<?php echo $customer['user_id']; ?>" class="staff-update-customer-btn">Update</a>
                    </div>
                    
                    <!-- Delete button container -->
                    <div class="button-container">
                        <a href="#" class="staff-delete-customer-btn" onclick="confirmDelete('<?php echo $customer['username']; ?>', <?php echo $customer['user_id']; ?>)">Delete</a>
                    </div>
                </td>
                </tr>
            <?php endforeach; ?>
    ...
    <script>
        ...
        function confirmDelete(username, userId) {
            if (confirm("Are you sure you want to delete " + username + "?")) {
                ...
                window.location.href = "staff-delete-customer.php?userId=" + userId;
            }
        }
