...
<div class="sidebar close">
  ...
  <section class="home-section">
    ...
    <div class="customer-form-container">
        <form id="customerForm" class="customer-form" action="staff-add-customer.php" method="post">
          ...
          <div class="staff-new-app-btn-container">
            ...
            <button type="submit" class="staff-new-app-btn-submit btn btn-flat btn-primary"><i class='bx bx-check'></i> Create</button>
            <!-- Cancel button -->
